...
FetchContent_Declare(
    cplotlib
    GIT_REPOSITORY https://github.com/josh-orio/cplotlib.git
    GIT_TAG main
)
FetchContent_MakeAvailable(cplotlib)

target_link_libraries(${EXEC} PRIVATE cplotlib)
```

> [!NOTE]
> Target should already be declared by this point.

Then include as normal:
```c++
